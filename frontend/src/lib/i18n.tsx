...
const DICT: Dict = {
  ...
  "conn.weekTokens": { zh: "本周 in/out", en: "Week in/out" },
  "conn.weekRequests": { zh: "本周请求", en: "Week requests" },
  "conn.monthTokens": { zh: "本月 in/out", en: "Month in/out" },
  "conn.monthRequests": { zh: "本月请求", en: "Month requests" },
  "conn.requests": { zh: "请求", en: "Requests" },
  "conn.inputTokens": { zh: "输入", en: "Input" },
  "conn.outputTokens": { zh: "输出", en: "Output" },
