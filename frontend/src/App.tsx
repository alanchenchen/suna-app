      ...
      <main className="grid min-h-dvh place-items-center p-6">
        {showInstall ? (
          ...
          >
            ...
            <button
              className="mt-6 inline-flex h-[42px] w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-blue text-[12px] font-extrabold text-white transition-colors duration-150 hover:bg-blue-strong active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-50"
